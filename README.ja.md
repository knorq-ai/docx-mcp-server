...
**40 ツール** — ドキュメント内容、書式設定、コメント、ページレイアウト、変更履歴を、ファイルアップロード不要の stdio トランスポートで処理する。
...
出力トークンは入力トークンの 5 倍の単価であるため、コード生成の省略はコストに大きく影響する。40 ツールのスキーマオーバーヘッド (~2,500 トークン) は 3–5 操作で回収できる。
